...
Avhengig av størrelsen på skjermen og og hvor gammel enheten din er vil handlingene enten være tilgjengelige via ikonene på verktøylinjen øverst, i rullegardin-menyen øverst til høyre, på verktøylinjen nederst (hvis tilstede) eller via meny-knappen.
...
#### Enkelt trykk, dobbelttrykk og lang trykk
...
Det er en god strategi å zoome inn hvis du prøver å redigere et område med høy tetthet.
