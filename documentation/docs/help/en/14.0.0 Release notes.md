...
* Merging a node in to another node or way will now show a context menu if their are multiple candidate target elements and offer the option of merging with all candiates. 
