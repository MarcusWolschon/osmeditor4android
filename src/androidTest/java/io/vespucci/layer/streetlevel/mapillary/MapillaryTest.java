...
import io.vespucci.layer.streetlevel.mapillary.MapillaryOverlay;
...
public class MapillaryTest {
    ...
    public void setup() {
        ...
        tileServer = MockTileServer.setupTileServer(main, "mapillary.mbt", true, LayerType.MAPILLARY, TileType.MVT,
                io.vespucci.layer.streetlevel.mapillary.MapillaryOverlay.MAPILLARY_TILES_ID);
    ...
    public void teardown() {
        ...
        try (TileLayerDatabase tlDb = new TileLayerDatabase(main); SQLiteDatabase db = tlDb.getWritableDatabase()) {
            TileLayerDatabase.deleteLayerWithId(db, io.vespucci.layer.streetlevel.mapillary.MapillaryOverlay.MAPILLARY_TILES_ID);
        }
    ...
    public void mapillaryLayer() {
        ...
        io.vespucci.layer.streetlevel.mapillary.MapillaryOverlay layer = (MapillaryOverlay) map.getLayer(LayerType.MAPILLARY);
        assertNotNull(layer);
