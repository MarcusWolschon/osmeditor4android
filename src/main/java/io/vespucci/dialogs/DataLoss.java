...
public class DataLoss extends ImmersiveDialogFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            intent = io.vespucci.util.Util.getParcelable(savedInstanceState, INTENT_KEY, Intent.class);
            requestCode = savedInstanceState.getInt(REQUESTCODE_KEY);
        } else {
            intent = io.vespucci.util.Util.getParcelable(getArguments(), INTENT_KEY, Intent.class);
