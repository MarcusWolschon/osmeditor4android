...
import io.vespucci.geocode.QueryNominatim;
...
public final class Server {
    ...
    private static Storage execQuery(@NonNull String url, @NonNull String query) throws IOException, SAXException {
        ...
        throw new OsmServerException(response.code(), io.vespucci.osm.Server.readStream(response.body().byteStream()));
    }
}
