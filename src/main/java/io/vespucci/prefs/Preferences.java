...
import io.vespucci.layer.streetlevel.AbstractImageOverlay;
...
public class Preferences {
    ...
    public Preferences(@NonNull Context ctx) {
        ...
        downloadRadius = getIntPref(R.string.config_extTriggeredDownloadRadius_key, io.vespucci.layer.data.MapOverlay.DEFAULT_AUTO_DOWNLOAD_RADIUS);
        ...
        autoPruneBoundingBoxLimit = getIntPref(R.string.config_autoPruneBoundingBoxLimit_key, io.vespucci.layer.data.MapOverlay.DEFAULT_DOWNLOADBOX_LIMIT);
        autoPruneNodeLimit = getIntPref(R.string.config_autoPruneNodeLimit_key, io.vespucci.layer.data.MapOverlay.DEFAULT_AUTOPRUNE_NODE_LIMIT);
        autoPruneTaskLimit = getIntPref(R.string.config_autoPruneTaskLimit_key, io.vespucci.layer.tasks.MapOverlay.DEFAULT_AUTOPRUNE_TASK_LIMIT);
        panAndZoomLimit = getIntPref(R.string.config_panAndZoomLimit_key, io.vespucci.layer.data.MapOverlay.PAN_AND_ZOOM_LIMIT);
