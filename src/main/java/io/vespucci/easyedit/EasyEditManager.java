...
import io.vespucci.easyedit.route.RestartRouteSegmentActionModeCallback;
...
import io.vespucci.easyedit.turnrestriction.RestartFromElementActionModeCallback;
import io.vespucci.easyedit.turnrestriction.ToElementActionModeCallback;
import io.vespucci.easyedit.turnrestriction.ViaElementActionModeCallback;
...
public class EasyEditManager {
     ...
     */
    public boolean editNote(@NonNull Note note, @NonNull io.vespucci.layer.tasks.MapOverlay layer) {
        synchronized (actionModeCallbackLock) {
