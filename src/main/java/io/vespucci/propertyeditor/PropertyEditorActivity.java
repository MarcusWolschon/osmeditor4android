...
public class PropertyEditorActivity<M extends Map<String, String> & Serializable, L extends List<PresetElementPath> & Serializable, T extends List<Map<String, String>> & Serializable>
    ...
    private void addFromIntent(@NonNull final Intent intent) {
        ...
        PropertyEditorData[] loadData = PropertyEditorData
                .deserializeArray(io.vespucci.util.Util.getSerializableExtra(intent, PropertyEditorFragment.TAGEDIT_DATA, PropertyEditorData[].class));
        boolean applyLastAddressTags = getPrimitiveBoolean(
                io.vespucci.util.Util.getSerializableExtra(intent, PropertyEditorFragment.TAGEDIT_LAST_ADDRESS_TAGS, Boolean.class));
        boolean showPresets = getPrimitiveBoolean(
                io.vespucci.util.Util.getSerializableExtra(intent, PropertyEditorFragment.TAGEDIT_SHOW_PRESETS, Boolean.class));
        ...
        Boolean usePaneLayout = io.vespucci.util.Util.getSerializableExtra(intent, PropertyEditorFragment.PANELAYOUT, Boolean.class);
