...
import io.vespucci.nsi.Names.TagMap;
...
import io.vespucci.propertyeditor.tagform.TagFormFragment;
...
public class PropertyEditorFragment<M extends Map<String, String> & Serializable, L extends List<PresetElementPath> & Serializable, T extends List<Map<String, String>> & Serializable>
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (usePaneLayout) { // add both preset fragments to panes
            ...
            io.vespucci.propertyeditor.Util.addMRUPresetsFragment(fm, R.id.pane_mru_layout, getElement().getOsmId(), getElement().getName());
    ...
    public PresetItem getBestPreset() {
        if (tagEditorFragment != null) {
            ...
            if (usePaneLayout) {
                ...
                io.vespucci.propertyeditor.Util.addAlternativePresetItemsFragment(getChildFragmentManager(), R.id.pane_alternative_layout, best);
            }
            return best;
        } else {
