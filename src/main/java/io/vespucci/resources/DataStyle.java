...
import io.vespucci.osm.StyleableFeature;
import io.vespucci.osm.Way;
import io.vespucci.presets.Preset;
import io.vespucci.resources.symbols.Symbols;
...
import io.vespucci.util.XmlFileFilter;
...
public final class DataStyle extends DefaultHandler {
    ...
    public static String[] getStyleListTranslated(@NonNull Context context, @NonNull String[] styleNames) {
        ...
        try (InputStream poFileStream = getPoFileStream(context, locale)) {
            Po po = io.vespucci.util.Util.parsePoFile(poFileStream);
            if (po != null) {
