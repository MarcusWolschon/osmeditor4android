...
import io.vespucci.layer.Downloader;
...
import io.vespucci.tasks.MapRouletteFragment;
...
import io.vespucci.tasks.OsmoseBugFragment;
...
public class MapOverlay extends NonSerializeableLayer
    ...
    private int         panAndZoomLimit    = io.vespucci.layer.data.MapOverlay.PAN_AND_ZOOM_LIMIT;
    ...
    private int     autoDownloadBoxLimit = io.vespucci.layer.data.MapOverlay.DEFAULT_DOWNLOADBOX_LIMIT;
