...
import io.vespucci.dialogs.DateRangeDialog;
import io.vespucci.layer.LayerType;
import io.vespucci.layer.streetlevel.AbstractImageOverlay;
import io.vespucci.layer.streetlevel.AbstractSequenceFetcher;
...
public class MapillaryOverlay extends AbstractImageOverlay {
    ...
    @Override
    public void setSelected(io.vespucci.util.mvt.VectorTileDecoder.Feature f) {
    ...
    @Override
    public SpannableString getDescription(@NonNull Context context, io.vespucci.util.mvt.VectorTileDecoder.Feature f) {
