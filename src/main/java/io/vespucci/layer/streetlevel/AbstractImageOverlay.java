...
import io.vespucci.resources.symbols.Mapillary;
...
public abstract class AbstractImageOverlay extends io.vespucci.layer.mvt.MapOverlay implements DateRangeInterface, SelectImageInterface {
     ...
     */
    protected boolean isPoint(@NonNull io.vespucci.util.mvt.VectorTileDecoder.Feature f) {
