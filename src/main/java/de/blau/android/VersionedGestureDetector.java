...
public abstract class VersionedGestureDetector {
    ...
    private static class CupcakeDetector extends VersionedGestureDetector {
        ...
        /**
         * Called when ACTION_DOWN is received. Schedules a long-click check for execution.
         * 
        ...
        /**
         * If a long-click check is scheduled, marks it as canceled. Call this when the click turned out not to be a
         * long-click (e.g. finger released, or drag/scale detected)
         */
        ...
        /**
         * Runnable checking for a long-press. Will be scheduled for execution by startLongPress.
         * 
         * If not cancelled, will notify the listener of the long-press event and set hasLongPressed.
         *
         */
        private class LongPressTrigger implements Runnable {
            ...
            /**
             * If this press turned out to be anything else than a long-press, call this to disable this
             * LongPressTrigger
             */
            public void cancel() {
                canceled = true;
