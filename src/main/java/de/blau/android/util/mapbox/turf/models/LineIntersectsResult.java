package de.blau.android.util.mapbox.turf.models;
 ...
 *
 * @see <a href="http://jsfiddle.net/justin_c_rounds/Gd2S2/light/">Good example of how this class works written in
 *      JavaScript</a>
 * @since 1.2.0
 */
public class LineIntersectsResult {
     ...
     *
     * @param onLine1 True if you want the intersecting point to lie on line 1, otherwise pass in false.
     * @since 1.2.0
     */
     ...
     *
     * @param onLine2 True if you want the intersecting point to lie on line 2, otherwise pass in false.
     * @since 1.2.0
     */
