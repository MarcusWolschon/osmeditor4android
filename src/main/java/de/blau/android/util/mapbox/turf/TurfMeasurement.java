...
class TurfMeasurement {
    ...
    /**
     * Takes a Position and calculates the location of a destination point given a distance in degrees, radians, miles,
     * or kilometers; and bearing in degrees. This uses the Haversine formula to account for global curvature.
     *
    ...
    /**
     * Calculates the distance between two positions in degress, radians, miles, or kilometers. This uses the Haversine
    ...
    /**
     * Calculates the distance between two points in kilometers. This uses the Haversine formula to account for global
     * curvature.
     *
    ...
    /**
     * Calculates the distance between two points in degress, radians, miles, or kilometers. This uses the Haversine
     * formula to account for global curvature.
     *
     * @param point1 Origin point.
     * @param point2 Destination point.
    ...
    private static double lineDistance(Geometry line, String units) throws TurfException {
        ...
        if (line.getType().equals("LineString")) {
            ...
            throw new TurfException("Input must be a LineString, MultiLineString, " + "Polygon, or MultiPolygon Feature or Geometry (or a FeatureCollection "
    ...
    /**
     * Takes two {@link Position} and returns a position midway between them. The midpoint is calculated geodesically,
     * meaning the curvature of the earth is taken into account.
     *
    ...
    public static Position midpoint(Position from, Position to) throws TurfException {
        ...
        return Position.fromCoordinates(midpointResult.getCoordinates().getLongitude(), midpointResult.getCoordinates().getLatitude());
    }

    /**
     * Takes two {@link Point} and returns a point midway between them. The midpoint is calculated geodesically, meaning
