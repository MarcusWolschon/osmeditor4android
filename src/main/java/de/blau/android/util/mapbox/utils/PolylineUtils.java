...
public class PolylineUtils {
     ...
     * @see <a href="https://github.com/mapbox/polyline/blob/master/src/polyline.js">Part of algorithm came from this
     *      source</a>
     * @see <a href=
     *      "https://github.com/googlemaps/android-maps-utils/blob/master/library/src/com/google/maps/android/PolyUtil.java">Part
     *      of algorithm came from this source.</a>
     * @since 1.0.0
     */
    ...
    /*
     * Polyline simplification method. It's a direct port of simplify.js to Java. See:
    ...
    /**
     * Reduces the number of points in a polyline while retaining its shape, giving a performance boost when processing
