...
class TurfJoins {
    ...
    /**
     * Takes a {@link Position} and a List of Positions making up a polygon and determines if the point resides inside
    ...
    /**
     * Takes a {@link Point} and a {@link Polygon} and determines if the point resides inside the polygon. The polygon
    ...
    /**
     * Takes a {@link Point} and a {@link MultiPolygon} and determines if the point resides inside the polygon. The
    ...
    private static boolean inRing(Position pt, List<Position> ring) {
        ...
        for (int i = 0, j = ring.size() - 1; i < ring.size(); j = i++) {
            ...
            boolean intersect = ((yi > pt.getLatitude()) != (yj > pt.getLatitude()))
