...
/**
 * A GeoJSON object with the type "FeatureCollection" is a feature object which represents a collection of feature
 * objects.
 *
 * @see <a href='geojson.org/geojson-spec.html#feature-collection-objects'>Official GeoJSON FeatureCollection
 *      Specifications</a>
 * @since 1.0.0
 */
public class FeatureCollection extends BaseFeatureCollection {
    ...
    /**
     * Protected constructor. Unlike other GeoJSON objects in this package, this constructor is protected to enable the
     * deserialization of the Map Matching service response.
     *
