...
/**
 * Required to handle the "Unable to invoke no-args constructor for interface {@link Geometry} error that Gson shows
 * when trying to deserialize a list of {@link Geometry}.
 *
 * @since 1.0.0
 */
public class GeometryDeserializer implements JsonDeserializer<Geometry> {
     ...
     * @throws JsonParseException This exception is raised if there is a serious issue that occurs during parsing of a
     *             Json string.
     * @since 1.0.0
     */
    @Override
