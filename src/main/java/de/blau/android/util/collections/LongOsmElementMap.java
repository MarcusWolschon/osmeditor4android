 ...
 * 
 * This only implements the, roughly equivalent to Map, interfaces that we
 * current (might) need and is rather Vespucci specific, however could easily be
...
public class LongOsmElementMap<V extends OsmElement> implements Iterable<V>,
		Serializable {
	/**
	 * 
	 */
