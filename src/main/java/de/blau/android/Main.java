...
public class Main extends ConfigurationChangeAwareActivity
    ...
    public void setImageFileName(@Nullable String savedImageFileName) {
        TakePicture takePicture = ((TakePicture) getTakePictureRequestLauncher().getContract());
        if (takePicture != null && savedImageFileName != null) {
    ...
    public String getImageFileName() {
        ...
        if (takePicture != null) {
            return takePicture.getImageFileName();
        }
        return null;
    }
    ...
    public void setImageAction(@Nullable ImageAction action) {
        TakePicture takePicture = ((TakePicture) getTakePictureRequestLauncher().getContract());
        if (takePicture != null && action != null) {
