...
Vespucci 是一个完整功能的开放街图编辑器，支持那些桌面系统编辑器所提供的大部分的操作。它在Android 2.3至5.1 已经过成功地测试。提醒一句：移动设置能力已经追上桌面系统与之匹敌，尤其是较旧的装置，只有非常有限的可用存储空间，并且往往是相当缓慢的。在使用Vespucci 和持有时，您应该考虑到与接受，例如，您正在编辑的区域尺寸是一个合理的大小。 
