...
Vespucci es un editor para OpenStreetMap con todas las funciones que soporta la mayoría de operaciones que proporciona editores de escritorio. Ha sido probado con éxito en Android 2.3 a 5.1. Unas palabras para tomar en cuenta: mientras que las capacidades de los dispositivos móviles alcanzaron a sus rivales de escritorio, en particular dispositivos antiguos tienen la memoria disponible muy limitada y tienden a ser bastante lentos. Debe tomar esto en cuenta cuando utilice Vespucci y mantener, por ejemplo, el tamaño de las áreas que está editando a un tamaño razonable. 
