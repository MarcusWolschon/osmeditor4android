...
public class Paints {
	...
	public final static int LANDUSE = 24;
	
	public final static int TRACKTYPE = 25;
	
	private final static int PAINT_COUNT = 26;
	...
	private void initPaints(final Resources resources) {
		...
		// one color for all landuse
		paint = new Paint();
		paint.setColor(resources.getColor(R.color.forest));
		paint.setTypeface(Typeface.SANS_SERIF);
		paint.setTextSize(12);
		paints[LANDUSE] = paint;
		
		// one color for all tracktypes
		paint = new Paint();
		paint.setColor(resources.getColor(R.color.tracktype));
		paint.setTypeface(Typeface.SANS_SERIF);
		paint.setTextSize(12);
		paints[TRACKTYPE] = paint;
	}
	...
	public void updateStrokes(final float newStrokeWidth) {
		...
		paints[LANDUSE].setStrokeWidth(newStrokeWidth * 0.5f); 
		
		paints[TRACKTYPE].setStrokeWidth(newStrokeWidth); 
