...
Note currently the test for maximum tag length enforcement fails on Android version before 7 and if you change the version and build number you need to patch the the test asset "test-result.osm". 
